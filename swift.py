...
if command.read():
	...
	f.write(f"import BuzzRxSwift\n\n")
	f.write(f"/// @mockable\n")
	f.write(f"protocol {fetchUseCaseClassName} {{\n")
	f.write(f"  func execute() -> Observable<[{domainName}]>\n")
	f.write("}\n\n")
	f.write(f"class {fetchUseCaseClassName}Impl: {fetchUseCaseClassName} {{\n")
...
if command.create():
	...
	f.write(f"import BuzzRxSwift\n\n")
	f.write(f"/// @mockable\n")
	f.write(f"protocol {saveUseCaseClassName} {{\n")
	f.write(f"  func execute({paramsDomainName}s: [{domainName}]) -> Observable<Void>\n")
	f.write("}\n\n")
	f.write(f"class {saveUseCaseClassName}Impl: {saveUseCaseClassName} {{\n")
	f.write(f"  private let repository: {repositoryClassName}\n\n")
	f.write(f"  init(repository: {repositoryClassName}) {{ self.repository = repository }}\n\n")
	f.write(f"  func execute({paramsDomainName}s: [{domainName}]) -> Observable<Void> {{ }}\n")
	f.write("}\n")
...
if command.delete():
	...
	f.write(f"import BuzzRxSwift\n\n")
	f.write(f"/// @mockable\n")
	f.write(f"protocol {deleteUseCaseClassName} {{\n")
	f.write(f"  func execute({paramsDomainName}s: [{domainName}]) -> Observable<Void>\n")
	f.write("}\n\n")
	f.write(f"class {deleteUseCaseClassName}Impl: {deleteUseCaseClassName}  {{\n")
	f.write(f"  private let repository: {repositoryClassName}\n\n")
	f.write(f"  init(repository: {repositoryClassName}) {{ self.repository = repository }}\n\n")
	f.write(f"  func execute({paramsDomainName}s: [{domainName}]) -> Observable<Void> {{ }}\n")
	f.write("}\n")
